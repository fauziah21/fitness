...
//
//        refreshToken.setUser(accountRepository.findByAccountId(userId).get());
...
//        return refreshTokenRepository.deleteByUser(accountRepository.findByAccountId(userId).get());
//    }
//
//}
