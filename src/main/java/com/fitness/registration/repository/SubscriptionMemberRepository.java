...
public interface SubscriptionMemberRepository extends JpaRepository<SubscriptionMemberModel,Integer> {
    Optional<SubscriptionMemberModel> findBySubscriptionIdAndSubsMemberAccountId(int subscriptionId,int subsMemberAccountId);
    Optional<SubscriptionMemberModel> findBySubMemberId(int subMemberId);
    Optional<SubscriptionMemberModel> findBySubsMemberAccountId(int subsMemberAccountId);
}
